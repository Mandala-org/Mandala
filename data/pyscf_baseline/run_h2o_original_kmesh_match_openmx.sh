...
RUN_NAME="${RUN_NAME:-h2o_original_rks_openmx_like_prod_k444}"
XC="${XC:-pbe,pbe}"
...
echo "Running production KRKS with kmesh=($KX $KY $KZ), xc=$XC, df_backend=$DF_BACKEND, run_name=$RUN_NAME"
