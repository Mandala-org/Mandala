...
def label_for_asset(filename: str) -> str:
    mapping = {
        ...
        "hamiltonian_aligned_correlation.png": "Hamiltonian aligned correlation",
        "hamiltonian_support_debug.png": "Hamiltonian support diagnostics",
        "hamiltonian_prediction_support_debug.json": "Hamiltonian support diagnostics JSON",
