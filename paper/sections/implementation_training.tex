...
Mandala supports pure matrix learning, mixed matrix-and-observable learning, and
...
operators. In the operator-centered workflow used throughout Mandala, the
...
$\Omega = \det(h)$ is the cell volume, Mandala uses
\begin{equation}
\widehat{\sigma}
=
\frac{1}{\Omega} h^{\top}
