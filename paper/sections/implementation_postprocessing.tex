...
established, Mandala evaluates their trace contraction as
\begin{equation}
\Tr(AB)
=
\sum_{(\bm{L},i,j)}
...
Mandala supports explicit sparse symmetrization after block reconstruction. In
...
evaluation and analysis workflows, Mandala computes
\begin{equation}
