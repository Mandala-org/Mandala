...
python -u scripts/wandb_run.py \
  ...
  --edge-update-pre-lin-mlp-n-layers 1 \
  --edge-update-post-lin-mlp-n-layers 1 \
  --node-update-pre-lin-mlp-n-layers 1 \
  --node-update-attention-mlp-n-layers 1 \
  --node-update-post-lin-mlp-n-layers 1 \
  --neck-depth 1 \
  --head-depth 3 \
