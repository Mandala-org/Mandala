...
def setup_argparse():
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="data/small/H2O/original/",
    )
    parser.add_argument(
        "--precision",
        type=str,
...
def main():
    ...
    matrix_file = os.path.join(args.data_path, "H2O.matrix")
    info_file = os.path.join(args.data_path, "H2O.info.out")
    fac.add_snapshot(matrix_file, info_file, purpose="train")
    ...
    print(f"Created dataloaders: train batches={len(train_loader)}")
