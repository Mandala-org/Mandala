...
CHECKPOINT="${CHECKPOINT:-/home/bartek/casus/mandala/checkpoints/zesty-sweep-135/best_model.pt}"
DATA_ROOT="${DATA_ROOT:-/home/bartek/casus/mandala/data/big/silicon}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/eval_outputs/zesty-sweep-135_gt_overlap}"
...
snapshot_path="${DATA_ROOT}/${TEMPERATURE}"
