...
CHECKPOINT_DIR="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/ZnCuSnSeS_hamiltonian_restart_hkgmr1y6_47h"
RESUME_CHECKPOINT="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/ZnCuSnSeS_hamiltonian_toprun_47h/zncusnses-toprun47h-seed47-scale1/latest_checkpoint.pt"
