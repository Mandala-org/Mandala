...
RUN_NAME="likely-sweep-22-restart-lr${LR_TAG}-seed${SEED}"
...
if [[ ! -f "${RESUME_CHECKPOINT}" ]]; then
  ...
  echo "Set RESUME_CHECKPOINT to the correct best_model.pt or latest_checkpoint.pt before launching." >&2
  exit 1
fi
