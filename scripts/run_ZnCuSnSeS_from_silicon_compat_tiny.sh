...
CHECKPOINT_DIR="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/ZnCuSnSeS_from_silicon_compat_tiny"
RESUME_CHECKPOINT="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/silicon_hamiltonian_300K_new_data_restart_sage_sweep_73/silicon_hamiltonian_300K_new_data_restart_sage_sweep_73_lr0p004_seed43/best_model.pt"
WANDB_PROJECT="mandala-ZnCuSnSeS-hamiltonian-compat"
RUN_NAME="zncusnses-silicon-compat-tiny-seed${SEED}"
