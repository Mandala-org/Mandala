...
from net.e3gnn import DeepHE3  # noqa: E402
...
def main():
    ...
    wandb_project = os.getenv("WANDB_PROJECT", "mandala_deephe3")
    ...
    fac = DatasetFactory(cfg, convention="openmx")
    ...
    model = DeepHE3(cfg=cfg, mapper=mapper)
