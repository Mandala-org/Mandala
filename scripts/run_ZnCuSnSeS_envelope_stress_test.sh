...
CHECKPOINT_DIR="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/ZnCuSnSeS_envelope_stress_test"
...
CMD=(
  ...
  --hamiltonian-envelope-mode normalize_target
  --pair-conditioned-radial-mlp true
  --pair-distance-normalization pair_r0
  --loss-weighting-mode envelope_inverse_sqrt_clipped
