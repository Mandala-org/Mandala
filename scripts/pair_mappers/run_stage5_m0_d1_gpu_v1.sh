...
mkdir -p artifacts/pair_stage5/sio2_m0_d1_validation_v1
python -u scripts/pair_mappers/run_stage5_m0_screen.py \
  ...
  --output-dir artifacts/pair_stage5/sio2_m0_d1_validation_v1 \
  ...
  2>&1 | tee artifacts/pair_stage5/sio2_m0_d1_validation_v1/launcher.log
