...
mkdir -p artifacts/pair_stage4/sio2_mapper_correctness_v2
python -u scripts/pair_mappers/run_stage4_correctness_suite.py \
  --output-dir artifacts/pair_stage4/sio2_mapper_correctness_v2 \
  ...
  2>&1 | tee artifacts/pair_stage4/sio2_mapper_correctness_v2/launcher.log
