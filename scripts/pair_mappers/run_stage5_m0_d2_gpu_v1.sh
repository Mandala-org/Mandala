...
mkdir -p artifacts/pair_stage5/sio2_m0_d2_validation_v1
python -u scripts/pair_mappers/run_stage5_m0_screen.py \
  --family d2 \
  --descriptor-cache-dir /bigdata/casus/wdm/hamiltonian_learning/data/pair_descriptor_hamiltonian/d2_sio2_v1 \
  --descriptor-summary artifacts/pair_stage2/d2_sio2_precompute_v1/summary.json \
  --descriptor-schemas artifacts/pair_stage2/d2_sio2_precompute_v1/descriptor_schemas.json \
  ...
  --output-dir artifacts/pair_stage5/sio2_m0_d2_validation_v1 \
  ...
  2>&1 | tee artifacts/pair_stage5/sio2_m0_d2_validation_v1/launcher.log
