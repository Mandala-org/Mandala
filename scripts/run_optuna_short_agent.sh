...
STUDY_YAML="${STUDY_YAML:-${ROOT_DIR}/sweeps/train_silicon_density_energy_bayes_short_optuna.yaml}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-${SCRATCH_DIR}/mandala_optuna_short/checkpoints}"
