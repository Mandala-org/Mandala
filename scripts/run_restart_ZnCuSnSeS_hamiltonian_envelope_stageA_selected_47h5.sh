...
LR="$1"
case "${LR}" in
  3e-3|0.003) LR_TAG="3em3" ;;
  25e-4|0.0025|2.5e-3) LR_TAG="25em4" ;;
  2e-3|0.002) LR_TAG="2em3" ;;
  15e-4|0.0015|1.5e-3) LR_TAG="15em4" ;;
  1e-3|0.001) LR_TAG="1em3" ;;
  *)
    echo "Unsupported lr: ${LR}" >&2
    echo "Expected one of: 0.003, 0.0025, 0.002, 0.0015, 0.001" >&2
    exit 1
    ;;
esac
...
RESUME_CHECKPOINT="/bigdata/casus/wdm/hamiltonian_learning/models/checkpoints/ZnCuSnSeS_hamiltonian_envelope_stageA_selected_47h5/dandy-sweep-34-restart47h5/latest_checkpoint.pt"
WANDB_PROJECT="mandala-ZnCuSnSeS-hamiltonian-envelope-stageA-selected-47h5"
RUN_NAME="dandy-sweep-34-restart47h5-lr${LR_TAG}"
